...
const Cart = () => {
  ...
  const fetchRazorpayConfig = async () => {
    try {
      const res = await axios.get('https://e-commerce-project-backend-fq6y.onrender.com/payment/config', {
  ...
  const fetchCartItems = async () => {
    try {
      setLoading(true)
      setError('')
      const res = await axios.get(`https://e-commerce-project-backend-fq6y.onrender.com/cart/user/${userId}`, {
  ...
  const fetchTotal = async () => {
    try {
      const res = await axios.get(`https://e-commerce-project-backend-fq6y.onrender.com/cart/total/${userId}`, {
        headers: { Authorization: `Bearer ${token}` },
      })
  ...
  const fetchProductMap = async () => {
    try {
      const res = await fetch('https://e-commerce-project-backend-fq6y.onrender.com/products?size=1000')
  ...
  const handleUpdateQuantity = async (cartItemId, newQty) => {
    ...
    try {
      const res = await axios.put(
        `https://e-commerce-project-backend-fq6y.onrender.com/cart/update/${cartItemId}`,
        { quantity: newQty },
        { headers: { Authorization: `Bearer ${token}` } }
      )
  ...
  const handleRemoveItem = async (cartItemId) => {
    ...
    try {
      const res = await axios.delete(`https://e-commerce-project-backend-fq6y.onrender.com/cart/remove/${cartItemId}`, {
        headers: { Authorization: `Bearer ${token}` },
      })
  ...
  const handleClearCart = async () => {
    ...
    try {
      const res = await axios.delete(`https://e-commerce-project-backend-fq6y.onrender.com/cart/clear/${userId}`, {
        headers: { Authorization: `Bearer ${token}` },
      })
  ...
  const handleVerifyCoupon = async () => {
    ...
    try {
      const res = await axios.post(
        'https://e-commerce-project-backend-fq6y.onrender.com/orders/verify-coupon',
  ...
  const handlePlaceOrder = async () => {
    ...
    try {
      const res = await axios.post(
        'https://e-commerce-project-backend-fq6y.onrender.com/orders/place',
        {
  ...
  const handleRazorpayPayment = async () => {
    ...
    try {
      ...
      const rpOrderRes = await axios.post(
        'https://e-commerce-project-backend-fq6y.onrender.com/payment/create-order',
      ...
      const options = {
        ...
        handler: async (response) => {
          ...
          try {
            await axios.post(
              'https://e-commerce-project-backend-fq6y.onrender.com/payment/verify',
              {
  ...
  const handleDownloadInvoice = async () => {
    ...
    try {
      const res = await axios.get(`https://e-commerce-project-backend-fq6y.onrender.com/orders/${placedOrder.id}/invoice`, {
        headers: { Authorization: `Bearer ${token}` },
        responseType: 'blob',
      })
  ...
  const handleSendInvoice = async () => {
    ...
    setEmailSent(false)
    try {
      await axios.get(`https://e-commerce-project-backend-fq6y.onrender.com/orders/${placedOrder.id}/send-invoice`, {
        headers: { Authorization: `Bearer ${token}` },
      })
      setEmailSent(true)
